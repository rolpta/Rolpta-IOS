...
function find_geo_country(cnt) {
  for (var key in countries_geodata) {
    if (countries_geodata.hasOwnProperty(key)) {
      if(countries_geodata[key].long_name.toLowerCase()==cnt.toLowerCase()) {
        return countries_geodata[key];
      }
    }
  }
  return {};
